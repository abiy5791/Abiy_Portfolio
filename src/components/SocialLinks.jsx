      ...
      <ul>
        {sociallinks_list.map(({ id, child, href, style, download }) => (
          <li
            key={id}
            className={
              "flex justify-between items-center w-40 h-14 px-4 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-700 bg-gray-800 hover:bg-gradient-to-r from-pink-800 to-blue-500" +
              " " +
              style
            }
          >
